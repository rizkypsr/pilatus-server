            ...
            <div class="bg-white">
                <table class="table-auto w-full">
                    ...
                    <tr>
                        ...
                        <th class="border px-2 py-2">Courier Type</th>
                        <th class="border px-6 py-4">Courier Price</th>
                    ...
                    <tbody>
                        @forelse($transaction as $item)
                            <tr>
                                ...
                                <td class="border px-6 py-4">{{ $item->courier_type }}</td>
                                <td class="border px-6 py-4">{{ $item->courier_price }}</td>
                                <td class="border px-6 py-4">{{ number_format($item->total) }}</td>
                                <td class="border px-6 py-4">{{ $item->status }}</td>
                                <td class="border px-6 py- text-center w-60">
